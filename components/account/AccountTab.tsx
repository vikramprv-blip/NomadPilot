...
const FEATURES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Dedicated Account Manager', free: false, premium: false, pro: false, elite: true },
    ],
  },
];
    ...
    <div>
      <div style={{ marginBottom: 16 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-dim)' }}>
          We'll notify you by email when prices drop below your target.
        </p>
      </div>
      ...
      {alerts.length === 0 ? (
        ...
        >
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: 14 }}>
            No alerts yet. Search for a flight and add an alert.
          </p>
        </div>
      ) : (
    ...
    <div style={{ maxWidth: 960, margin: '0 auto', padding: '32px 0' }}>
      ...
      {section === 'alerts' ? (
        ...
        <>
          ...
          <div>
            <h3
              style={{ fontSize: 26, fontWeight: 700, textAlign: 'center', marginBottom: 8 }}
            >
            ...
            >
              Find the perfect plan for your travel style.
            </p>
                ...
                {['Free', 'Premium', 'Pro', 'Elite'].map((p, i) => (
                  <div
                    ...
                    style={{
                      ...
                      fontWeight: 700,
                      fontSize: 13,
                      color: [undefined, '#3b82f6', '#8b5cf6', '#e8a020'][i],
                    }}
                  >
                    {p}
                  </div>
            ...
            >
              All plans include a 7‑day free trial · Cancel anytime · Stripe & PayPal
              supported
            </p>
          </div>
        </>
